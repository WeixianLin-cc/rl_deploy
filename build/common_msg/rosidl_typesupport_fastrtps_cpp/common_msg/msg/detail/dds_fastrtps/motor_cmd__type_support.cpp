...
#include "common_msg/msg/detail/motor_cmd__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const common_msg::msg::MotorCmd & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  common_msg::msg::MotorCmd & ros_message)
{
  // Member: mode
  cdr >> ros_message.mode;
...
{
  auto typed_message =
    static_cast<const common_msg::msg::MotorCmd *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<common_msg::msg::MotorCmd *>(
    untyped_ros_message);
...
{
  return &common_msg::msg::typesupport_fastrtps_cpp::_MotorCmd__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, common_msg, msg, MotorCmd)() {
  return &common_msg::msg::typesupport_fastrtps_cpp::_MotorCmd__handle;
}
