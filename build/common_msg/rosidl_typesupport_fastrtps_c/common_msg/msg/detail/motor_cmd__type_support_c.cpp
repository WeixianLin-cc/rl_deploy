...
#include "common_msg/msg/detail/motor_cmd__rosidl_typesupport_fastrtps_c.h"
...
using _MotorCmd__ros_msg_type = common_msg__msg__MotorCmd;
...
static uint32_t _MotorCmd__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_common_msg__msg__MotorCmd(
...
{
  return max_serialized_size_common_msg__msg__MotorCmd(
    full_bounded, 0);
}
