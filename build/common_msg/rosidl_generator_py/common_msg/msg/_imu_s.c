...
bool common_msg__msg__imu__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("common_msg.msg._imu.Imu", full_classname_dest, 23) == 0);
  }
  common_msg__msg__Imu * ros_message = _ros_message;
  {  // quaternion
...
PyObject * common_msg__msg__imu__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("common_msg.msg._imu");
