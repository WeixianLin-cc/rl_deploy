...
bool common_msg__msg__motor_control_cmd__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("common_msg.msg._motor_control_cmd.MotorControlCmd", full_classname_dest, 49) == 0);
  }
  common_msg__msg__MotorControlCmd * ros_message = _ros_message;
  {  // mode
  ...
  {  // motor_id_new
    PyObject * field = PyObject_GetAttrString(_pymsg, "motor_id_new");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->motor_id_new = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // speed
...
{
  /* NOTE(esteve): Call constructor of MotorControlCmd */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("common_msg.msg._motor_control_cmd");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MotorControlCmd");
  ...
  {  // motor_id_new
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->motor_id_new);
    {
      int rc = PyObject_SetAttrString(_pymessage, "motor_id_new", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
